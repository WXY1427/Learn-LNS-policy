...
if __name__ == '__main__':
    ...
    print("{} train instances for {} samples".format(len(instances_train),train_size))
    print("{} validation instances for {} samples".format(len(instances_valid),valid_size))
    print("{} test instances for {} samples".format(len(instances_test),test_size))
