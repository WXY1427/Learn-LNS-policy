...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        # train instances
        n = 5000
        lp_dir = 'data/instances/setcover/train_{}r_{}c_{}d'.format(nrows,ncols,dens)
...
#        # train instances
#        n = 100
#        lp_dir = 'data/instances/cauctionsnpy/train_{}_{}'.format(number_of_items,number_of_bids)
#        print("{} instances in {}".format(n,lp_dir))
#        os.makedirs(lp_dir)
#        filenames.extend([os.path.join(lp_dir, 'instance_{}.npy'.format(i+1)) for i in range(n)])
#        nitemss.extend([number_of_items] * n)
#        nbidss.extend([number_of_bids ] * n)

#        # validation instances
#        n = 20
#        lp_dir = 'data/instances/cauctionsnpy/valid_{}_{}'.format(number_of_items,number_of_bids)
#        print("{} instances in {}".format(n,lp_dir))
#        os.makedirs(lp_dir)
#        filenames.extend([os.path.join(lp_dir, 'instance_{}.npy'.format(i+1)) for i in range(n)])
...
#        nbidss.extend([number_of_bids ] * n)
        ...
        number_of_bids = 16000
        lp_dir = 'data/instances/cauctions/test3_{}_{}'.format(number_of_items,number_of_bids)
        print("{} instances in {}".format(n,lp_dir))
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, 'instance_{}.lp'.format(i+1)) for i in range(n)])
        nitemss.extend([number_of_items] * n)
