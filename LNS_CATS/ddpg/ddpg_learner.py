...
class DDPG(object):
    def __init__(self, actor, critic, memory, observation_shape, action_shape, param_noise=None, action_noise=None,
        ...
        self.obs0 = tf.placeholder(tf.float32, shape=(None,) + observation_shape + (22,), name='obs0')
        self.obs1 = tf.placeholder(tf.float32, shape=(None,) + observation_shape + (22,), name='obs1')
