...
def init_scip_params(model, seed, heuristics=False, presolving=False, separating=True, conflict=False):
...
def init_scip_paramsH(model, seed, heuristics=False, presolving=False, separating=False, conflict=False):
