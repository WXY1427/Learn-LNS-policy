...
def learn(args,network='mlp',
          ...
          batch_size=300, # per MPI worker  64 32  64   128   64  128
          tau=0.01,
          eval_env=None,
    ...
    if args.problem == 'setcover':
        ...
        instances_valid += ["data/instances/setcover/test_5000r_1000c_0.05d/instance_{}.lp".format(i+1) for i in range(50)]
