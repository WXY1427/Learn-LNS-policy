...
@register("mlp")
def mlp(num_layers=1, num_hidden=128, activation=tf.tanh, layer_norm=False): #### tf.nn.relu
    """
    ...
    def network_fn(X):
        ...
        for i in range(num_layers):
            ...
            if layer_norm:
                h = tf.contrib.layers.batch_norm(h, center=True, scale=True)
