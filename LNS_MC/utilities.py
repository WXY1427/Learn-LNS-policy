...
def init_scip_paramsH(model, seed, heuristics=True, presolving=False, separating=False, conflict=False):
...
#    col_feat_names = ['reduced_cost','has_lb','coef_normalized','avg_inc_val','age','sol_is_at_ub','sol_is_at_lb','sol_frac','type','has_ub','inc_val','basis_status','sol_val']
    ...
    col_feat_names = ['reduced_cost','has_lb','coef_normalized','age','sol_is_at_ub','sol_is_at_lb','sol_frac','has_ub','basis_status','sol_val']
